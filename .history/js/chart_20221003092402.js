...
// const weeklyToggleButton = document.getElementById("toggleButton");

// weeklyToggleButton.addEventListener("change", toggleChart);
// function toggleChart() {
//   const cart = document.getElementById("myChart");

//   if (weeklyToggleButton.checked == true) {
...
function toggleChart() {
  ...
  if (monthlyToggleButton.checked == true) {
    cart.style.display = "none";
